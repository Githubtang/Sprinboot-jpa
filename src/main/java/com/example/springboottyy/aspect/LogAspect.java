...
import com.example.springboottyy.common.filter.PropertyPreExcludeFilter;
import com.example.springboottyy.enums.BusinessStatus;
import com.example.springboottyy.enums.HttpMethod;
...
import com.example.springboottyy.utils.ExceptionUtil;
    ...
    protected void handleLog(final JoinPoint joinPoint, Log controllerLog, final Exception e, Object jsonResult) {
        try {
            ...
            if (loginUser != null) {
                ...
                if (StringUtils.isNotNull(currentUser) && StringUtils.isNotNull(deptRepository.findById(currentUser.getDeptId()).get())) {
                    operLog.setDeptName(deptRepository.findById(currentUser.getDeptId()).get().getDeptName());
                }
            }
